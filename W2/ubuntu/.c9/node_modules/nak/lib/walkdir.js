...
var finalizer;
var allPaths = Object.create(null);
var allStats = Object.create(null);
var allLinks = Object.create(null);
var ended = 0;
var jobs = 0;
...
exports.walkdir = function(fpath, options, printCb, done) {
  ...
  var readdir = function(filepath) {
    ...
    fs.readdir(fpath + filepath, function(_err, files) {
